...
export const messages = {
  ja: {
    ...
    "locale.next": "한국어",
    "footer.tagline": "ゲームとコード、制作過程を記録する個人アーカイブ。",
    ...
    "blog.title": "作る過程を、言葉でも残す。",
    "blog.description": "ゲーム開発、設計、実装、学び。進行中の制作に残した記録を、新しい順にまとめています。",
    ...
    "home.logs.description": "実装、設計、試行錯誤を残した直近の開発記録。",
    ...
    "home.github.description": "公開リポジトリに残る、直近の制作の足跡。",
    "home.github.profile": "GitHub プロフィールへ",
    "home.github.board.eyebrow": "PROJECT BOARD",
    "home.github.board.title": "Astral Days! Development",
    "home.github.board.description": "『アスデイ』の公開開発ボード。進行中の制作管理は GitHub Projects で記録しています。",
    ...
    "home.contact.description": "ゲーム開発、技術、ポートフォリオについての連絡は、GitHub またはメールからどうぞ。",
  },
  ko: {
    "skip-link": "본문으로 이동",
    "nav.label": "주요 탐색",
    ...
    "blog.eyebrow": "DEVELOPMENT ARCHIVE",
    "blog.title": "만드는 과정을, 말로도 남긴다.",
    "blog.description": "게임 개발, 설계, 구현, 배움. 진행 중인 제작 과정에서 남긴 기록을 최신순으로 모아 두었습니다.",
    "blog.order": "LATEST → OLDEST",
    "blog.count": "RECORDS",
    "blog.filter.label": "FILTER BY CATEGORY",
    "blog.filter.all": "ALL",
    ...
    "home.github.title": "GitHub Activity",
    "home.github.description": "공개 저장소에 남은 최근 제작의 흔적입니다.",
